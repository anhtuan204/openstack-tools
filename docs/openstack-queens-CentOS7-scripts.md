#### Hướng dẫn thực thi script cài đặt OpenStack Queens không có HA trên CentOS 7
...
- Kiểm tra lại xem đã thao tác được với OpenStack bằng CLI hay chưa bằng lệnh
	...
	| Field      | Value                                                                                                                                                                                   |
	+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
	| expires    | 2018-09-30T18:05:00+0000                                                                                                                                                                |
	| id         | gAAAAABbsQI8Rc0OZXxsSpz1iKfOdB6B4HBnCZlfFcxifNhAue4CX3LdsU3MRHtoO7OnUTr3dIQbqa1-BaLRQjaMGCfGkGtYQCku5-kuANgyPvHu3yR85Rw9wkj1-i-4hi0yAFobavV-sBpoTfNBGzwDvRkSZaGZDS7DYfDAvKnXRUcdE2amXjg |
	| project_id | 1f8eda6b49364129a2231d209675e2b9                                                                                                                                                        |
	| user_id    | aa8f084559f14083b681bd27204a6069                                                                                                                                                        |
	+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
	```
...
- Kết quả như sau là đã hoàn tất việc cài nova trên controller
	...
	+----+------------------+-------------+----------+---------+-------+----------------------------+
	|  1 | nova-scheduler   | controller1 | internal | enabled | up    | 2018-09-30T16:53:50.000000 |
	|  2 | nova-consoleauth | controller1 | internal | enabled | up    | 2018-09-30T16:53:50.000000 |
	|  3 | nova-conductor   | controller1 | internal | enabled | up    | 2018-09-30T16:53:51.000000 |
	+----+------------------+-------------+----------+---------+-------+----------------------------+
	[root@controller1 CentOS7]# 
	```
